...
muGenie.py is my attempt at this Genie.
'''
...
def genie(lst,gens):
    ...
    for i in range(gens):
        #print(i,genList)
        nextgen = []
        testList = lst[generation] # get the list of this generation
...
genie(genList,4)  # pass a list and number of generations to compute don't do more than 8
printList()
